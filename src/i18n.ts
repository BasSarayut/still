...
const th = {
  ...
  template: 'เครื่องเล่นเพลง', sideNote: 'จากสิ่งเล็ก ๆ ที่คุณรัก', makeYours: 'สร้างให้เป็นคุณ',
...
const en: Messages = {
  ...
  template: 'Music player', sideNote: 'Made of your favorite things', makeYours: 'Make it yours.',
...
const ja: Messages = {
  ...
  template: 'ミュージックプレーヤー', sideNote: 'あなたの好きなものを集めて', makeYours: 'あなたらしい一枚に。',
