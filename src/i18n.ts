...
const th = {
  ...
  polaroidPostcardHint: 'กระดาษน้ำตาลอุ่น · สไตล์โปสการ์ด', polaroidScrapbookHint: 'สีสันสดใส · มุมยึดรูปและเทป', polaroidFormalHint: 'กระดาษไอวอรี่ · จัดกึ่งกลางเรียบหรู',
  ...
  polaroidTexture: 'พื้นผิวกระดาษ', polaroidSmooth: 'เรียบ', polaroidFiber: 'ใยกระดาษ', polaroidAged: 'กระดาษเก่า', polaroidTextureAmount: 'ความเข้มพื้นผิว',
  polaroidDecorations: 'เทป โน้ต และรายละเอียด', polaroidTape: 'เทปตกแต่ง', polaroidTapeTop: 'แถบด้านบน', polaroidTapeCorners: 'มุมบนสองข้าง', polaroidTapeColor: 'สีเทป', polaroidCorners: 'มุมยึดรูปสามเหลี่ยม',
  ...
  playerGradientEnd: 'สีปลายไล่เฉด', playerAngle: 'ทิศทางไล่สี', playerDarkness: 'เพิ่มความเข้มพื้นหลัง', playerPhotoHint: 'ดึงสีจากภาพเป็นพื้นหลังมืด เปลี่ยนเป็นสีล้วนหรือไล่สีเพื่อเลือกสีเองได้',
  ...
  paletteGradient: 'แถบไล่สี', paletteRibbon: 'ริบบิ้นแนวตั้ง', paletteNecklace: 'จุดเชื่อมเส้น', paletteNumbered: 'สวอตช์มีเลข', paletteHero: 'สีเด่น + จุดเสริม',
  paletteOrder: 'การเรียงลำดับสี', paletteOrderFrequency: 'สีเด่นสุดก่อน', paletteOrderLuminance: 'มืดไปสว่าง', paletteOrderHue: 'ตามวงล้อสี',
  paletteCount: 'จำนวนสี', paletteSize: 'ขนาดชุดสี', paletteGap: 'ระยะห่างชุดสี',
  ...
  automatic: 'อัตโนมัติ', showPalette: 'แสดงชุดสี', signature: 'ลายเซ็นของคุณ',
...
const en: Messages = {
  ...
  polaroidPostcardHint: 'Warm cream paper · postcard style', polaroidScrapbookHint: 'Bright colors · corner mounts & tape', polaroidFormalHint: 'Ivory paper · elegant centered look',
  ...
  polaroidTexture: 'Paper texture', polaroidSmooth: 'Smooth', polaroidFiber: 'Paper fibers', polaroidAged: 'Aged paper', polaroidTextureAmount: 'Texture strength',
  polaroidDecorations: 'Tape, notes & details', polaroidTape: 'Decorative tape', polaroidTapeTop: 'Top strip', polaroidTapeCorners: 'Both top corners', polaroidTapeColor: 'Tape color', polaroidCorners: 'Photo corner mounts',
  ...
  paletteGradient: 'Gradient bar', paletteRibbon: 'Vertical ribbon', paletteNecklace: 'Connected dots', paletteNumbered: 'Numbered swatches', paletteHero: 'Hero + accents',
  paletteOrder: 'Color order', paletteOrderFrequency: 'Most dominant first', paletteOrderLuminance: 'Dark to light', paletteOrderHue: 'Color wheel',
  paletteCount: 'Number of colors', paletteSize: 'Palette size', paletteGap: 'Palette spacing',
...
const ja: Messages = {
  ...
  polaroidPostcardHint: '温かみのあるクリーム紙・ポストカード風', polaroidScrapbookHint: '鮮やかな色・コーナー留めとテープ', polaroidFormalHint: 'アイボリー紙・上品な中央揃え',
  ...
  polaroidTexture: '紙の質感', polaroidSmooth: 'なめらか', polaroidFiber: '紙の繊維', polaroidAged: '古い紙', polaroidTextureAmount: '質感の強さ',
  polaroidDecorations: 'テープ・メモ・詳細', polaroidTape: '飾りテープ', polaroidTapeTop: '上部に1枚', polaroidTapeCorners: '上部の両隅', polaroidTapeColor: 'テープの色', polaroidCorners: '写真の角留め',
  ...
  paletteGradient: 'グラデーションバー', paletteRibbon: '縦のリボン', paletteNecklace: 'つながったドット', paletteNumbered: '番号付きスウォッチ', paletteHero: 'メインカラー + アクセント',
  paletteOrder: '色の並び順', paletteOrderFrequency: '多い色から順に', paletteOrderLuminance: '暗い色から明るい色へ', paletteOrderHue: '色相順',
  paletteCount: '色の数', paletteSize: 'パレットのサイズ', paletteGap: 'パレットの間隔',
