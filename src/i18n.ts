...
const th = {
  ...
  template: 'เครื่องเล่นเพลง', templateNowPlaying: 'Now Playing (ธีมมืด)', templatePolaroid: 'โพลารอยด์',
...
const en: Messages = {
  ...
  template: 'Music player', templateNowPlaying: 'Now Playing (dark)', templatePolaroid: 'Polaroid',
...
const ja: Messages = {
  ...
  template: 'ミュージックプレーヤー', templateNowPlaying: 'Now Playing(ダーク)', templatePolaroid: 'ポラロイド',
