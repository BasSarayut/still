...
const words = {
  th: { variant: 'การจัดวาง', balanced: 'สมดุล', top: 'ข้อความด้านบน', side: 'ข้อความด้านข้าง', image: 'กรอบและตำแหน่งรูป', x: 'แนวนอน (%)', y: 'แนวตั้ง (%)', width: 'ความกว้าง (%)', height: 'ความสูง (%)', rotation: 'หมุนรูป (°)', radius: 'มุมโค้ง', opacity: 'ความชัดของรูป', border: 'ความหนากรอบ', background: 'พื้นหลัง', solid: 'สีพื้น', gradient: 'ไล่สี', blur: 'ภาพเบลอ', end: 'สีไล่ระดับ', effects: 'เอฟเฟกต์', grain: 'เกรนฟิล์ม', fade: 'สีเฟด', vignette: 'ขอบมืด', lightLeak: 'แสงรั่ว', overlay: 'เงาช่วยอ่านข้อความ', decoration: 'ของตกแต่ง', none: 'ไม่มี', line: 'เส้น', tape: 'เทป', label: 'ฉลาก', film: 'กรอบฟิล์ม', color: 'สีของตกแต่งและกรอบ', amount: 'ความชัดของตกแต่ง', presets: 'สไตล์ของฉัน', name: 'ชื่อสไตล์', save: 'บันทึกสไตล์', load: 'ใช้สไตล์', remove: 'ลบ', failure: 'บันทึกไม่ได้ พื้นที่จัดเก็บอาจเต็มหรือถูกปิด', hint: 'เก็บการจัดวางทั้งสองสัดส่วนและสี โดยใช้รูปและข้อความปัจจุบัน', saved: 'บันทึกแล้ว', reset: 'เริ่มการจัดวางใหม่' },
